...
export async function render() {
  ...
  <div class="page page--wide" style="padding-top:0;">
    ...
    <!-- HERO -->
    <section class="hero">
      <p class="hero__eyebrow"><img src="assets/pycatalog-logo.svg" class="pc-logo pc-logo--eyebrow" alt="" aria-hidden="true" /> Каталог Python проектов</p>
    ...
    <section class="page" style="padding-top:0;padding-bottom:3rem;">
      <div class="pylaunch-banner" id="pylaunch-banner">
        ...
        <img src="assets/pylaunch-logo.svg" class="pylaunch-logo pylaunch-logo--banner" alt="" aria-hidden="true" />
      </div>
    </section>
